...
const MedicineSchema = new Schema<IMedicine>(
  {
    ...
    unitCost: {
      ...
      required: true,
      default: 0,
      validate: { validator: Number.isInteger, message: "Unit cost must be a whole number (no decimals)" },
    },
    sellingPrice: {
      type: Number,
      required: true,
      default: 0,
      validate: { validator: Number.isInteger, message: "Selling price must be a whole number (no decimals)" },
    },
